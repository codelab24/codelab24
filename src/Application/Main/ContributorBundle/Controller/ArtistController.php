...
namespace Application\Main\ContributorBundle\Controller;
...
use Application\Main\ContributorBundle\Entity\Artist;
use Application\Main\ContributorBundle\Form\ArtistType;
...
class ArtistController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ApplicationMainContributorBundle:Artist')->findAll();
     ...
     * @Method("POST")
     * @Template("ApplicationMainContributorBundle:Artist:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ApplicationMainContributorBundle:Artist')->find($id);
        ...
        $image = $session->set('image', array('type' => 'artist', 'id' => $id));
        $album = $session->set('album_artist', $id);
     ...
     * @Method("PUT")
     * @Template("ApplicationMainContributorBundle:Artist:edit.html.twig")
     */
